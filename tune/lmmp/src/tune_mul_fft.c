...
static uint64_t get_threshold(void) { return (uint64_t)lmmp_tune_MUL_FFT_THRESHOLD; }
static void set_threshold(uint64_t v) { lmmp_tune_MUL_FFT_THRESHOLD = v; }
...
int tune_run_mul_fft(void) {
    ...
    spec.macro_name = "MUL_FFT_THRESHOLD";
    spec.low_name = "mul_toom44";
